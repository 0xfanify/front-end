...
import SidebarMenu from '@/components/trading/SidebarMenu';
...
import SeasonSection from '@/components/trading/SeasonSection';
import TransactionsSection from '@/components/trading/TransactionsSection';
import FanTokensSection from '@/components/trading/FanTokensSection';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        {(activeSection === 'staking' || activeSection === 'rewards' || activeSection === 'season' || activeSection === 'fantokens' || activeSection === 'transactions') && !isConnected ? (
